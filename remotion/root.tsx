...
const placeholder: StoryPlan = {
  ...
  scenes: [
    {id: 'placeholder', type: 'hook', durationSeconds: 45, headline: 'Founder Build in Public', body: 'Building creates the story.', narration: 'The work already contains the story.', evidenceIds: [], accent: '#FFCC66'},
  ],
};
